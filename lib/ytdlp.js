...
// hoặc bị chặn bởi màn xác minh "không phải bot" (BOT_CHECK_ERROR) — cả hai đều thường do
// client "web_embedded" (ưu tiên dùng để tránh lỗi 403, xem giải thích ở YOUTUBE_EXTRACTOR_ARGS)
// bị YouTube chặn/giới hạn riêng cho video hoặc mạng đó, trong khi client khác (yt-dlp tự chọn
// khi không giới hạn, vd "android_vr") vẫn tải bình thường. Thử lại bỏ hẳn giới hạn client VÀ
// dùng "-f best" trần không lọc gì, để không bao giờ tải thất bại chỉ vì không khớp đúng mức
// chất lượng yêu cầu.
